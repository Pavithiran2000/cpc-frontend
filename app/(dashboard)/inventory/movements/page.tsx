...
export default function StockMovementsPage() {
  ...
  const filters = useMemo(
    () => ({ page, limit, search, date_from: dateFrom || undefined, date_to: dateTo || undefined }),
      ...
      <div className="flex flex-wrap items-center gap-3">
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            className="rounded-lg border border-white/10 bg-white/5 px-2.5 py-1.5 text-xs text-white/70 outline-none focus:border-[#E85D04]/50 number"
          />
        </div>
        <div className="flex items-center gap-2">
